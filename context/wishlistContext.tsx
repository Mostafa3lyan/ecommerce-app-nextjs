...
import getWishlist from "@/lib/api/wishlist/getWishlist";
import removeWishlist from "@/lib/api/wishlist/removeWishlist";
import addToWishlistapi from "@/lib/api/wishlist/addToWishlist"; // Import addToWishlist API
